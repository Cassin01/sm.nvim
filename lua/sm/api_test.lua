...
package.loaded["sm.memo"] = {list = _5_, ["get-memo-info"] = _6_, open = _7_}
...
package.loaded["sm.tags"] = {["get-memo-tags"] = _8_, ["get-tags-with-counts"] = _10_, ["get-memos-by-tag"] = _11_}
local function _13_()
  return "/tmp/test-memos"
end
package.loaded["sm.config"] = {["get-memos-dir"] = _13_}
